...
const dict = {
  ...
  // Header tooltips
  tipBackToMenu: { en: "Back to main menu", pl: "Powrót do menu głównego" },
  ...
  subTitle: { en: "Can you conquer the entire board and classify all 151 first-generation Pokémon?", pl: "Czy zdołasz przejąć całą planszę i sklasyfikować wszystkie 151 Pokémonów pierwszej generacji?" },
  rule1: { en: "You occupy Pallet Town in the bottom-left corner of the board.", pl: "Zajmujesz Alabastię w lewym dolnym rogu planszy." },
  ...
  introCardTimerValue: { en: "45 SEC", pl: "45 SEK" },
  introCardTimerLabel: { en: "PER ROUND", pl: "NA RUNDĘ" },
  introCardTimerDesc: { en: "That's all you get to name it.", pl: "Tyle masz na nazwę." },
  introCardLangValue: { en: "EN", pl: "EN" },
  introCardLangLabel: { en: "IN ENGLISH", pl: "PO ANGIELSKU" },
  introCardLangDesc: { en: "e.g. Ponyta.", pl: "np. Ponyta." },
  introCardPenaltyValue: { en: "-5", pl: "-5" },
  introCardPenaltyLabel: { en: "PASS", pl: "PAS" },
  introCardPenaltyDesc: { en: "PASS subtracts seconds.", pl: "PAS odejmuje sekundy." },
  ...
  vsPlayerLocation: { en: "PALLET TOWN", pl: "ALABASTIA" },
  ...
  helpCardSubtitle: { en: "3 chapters · ~1 min read", pl: "3 rozdziały · czas czytania ~1 min" },
  helpAboutPill: { en: "ABOUT", pl: "O GRZE" },
  helpAboutBody: { en: "The app is based on the popular gameshow format 'The Floor', set in the legendary Kanto region from the first Pokémon series (first generation 1–151).", pl: "Aplikacja oparta jest na popularnej formule teleturnieju The Floor, usytuowanym w legendarnej krainie Kanto z pierwszej serii animacji Pokémon (pierwsza generacja 1–151)." },
  helpChapter1Chip: { en: "ENG", pl: "ENG" },
  helpChapter1Title: { en: "OFFICIAL NAMING", pl: "OFICJALNE NAZEWNICTWO" },
  helpChapter1Demo: { en: "'Garbatek' → Charizard", pl: "„Garbatek\" → Charizard" },
  ...
  histGoal1Title: { en: "Begin the journey from Pallet Town", pl: "Rozpoczęcie wyprawy z Alabastii" },
  ...
  guideTitle: { en: "HELP & GUIDE", pl: "POMOC & PRZEWODNIK" },
  guideClose: { en: "Close", pl: "Zamknij" },
  guideDesc1: { en: "The app is based on the popular game show format 'The Floor', set in the legendary Kanto region from the first Pokémon series (first generation 1–151).", pl: "Aplikacja oparta jest na popularnej formule teleturnieju The Floor, usytuowanym w legendarnej krainie Kanto z pierwszej serii animacji Pokémon (pierwsza generacja 1–151)." },
  guideTipsTitle: { en: "💡 TYPING & RECOGNITION TIPS:", pl: "💡 WSKAZÓWKI WPISYWANIA I ROZPOZNAWANIA:" },
  guideTip1: { en: "Official Naming: We use the official English names (e.g., Charizard, Bulbasaur, Squirtle) — the internationally recognized names used on the cards, in the games, and in the anime.", pl: "Oficjalne nazewnictwo: Używamy oficjalnych angielskich nazw (np. Charizard, Bulbasaur, Squirtle) — to międzynarodowo rozpoznawane nazwy z kart, gier i anime, również w Polsce." },
  guideTip2: { en: "Speech Recognition (Speech To Text): Click the microphone icon and speak the English name clearly. The app has a smart accent/phonetic recognition engine, allowing pronunciations like 'Pikaczu' for Pikachu or 'Czarizard' for Charizard to be accepted!", pl: "Rozpoznawanie mowy (Speech To Text): Kliknij ikonę mikrofonu i powiedz wyraźnie nazwę po angielsku. Program posiada inteligentny mechanizm rozpoznawania akcentów i fonetyki, co pozwala zaliczyć odpowiedzi wypowiedziane jako 'Pikaczu' dla Pikachu lub 'Czarizard' dla Charizard!" },
  guideTip3: { en: "Round Time Limit (Rules): The active player's clock runs down continuously. To transfer time to your rival and pause your clock, you must submit a CORRECT Pokémon name. This shifts possession and gives the opponent their challenge.", pl: "Limit rundy (Zasady): Zegar aktywnego zawodnika nieustannie ucieka. Aby przerzucić czas na rywala i zatrzymać swój czas, musisz podać PRAWIDŁOWĄ nazwę Pokémona na ekranie. Przełączasz wtedy ruch i przeciwnik otrzymuje swoje wyzwanie." },
  guideOk: { en: "I understand, let's play!", pl: "Rozumiem, grajmy!" },
  ...
  logInit1: { en: "Start your journey representing Pallet Town (Bottom Left Corner)!", pl: "Rozpocznij wyprawę reprezentując Alabastię (Dolny Lewy Róg)!" },
  ...
  logReset1: { en: "New game started! Pallet Town is ready to conquer Kanto.", pl: "Nowa gra rozpoczęta! Alabastia gotowa do podboju Kanto." },
